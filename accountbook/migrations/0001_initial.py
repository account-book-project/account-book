    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'transaction_details',
                    models.CharField(max_length=255, verbose_name='거래 내용'),
                ),
                (
                    'transaction_type',
                    models.CharField(
                ...
                (
                    ...
                    models.DateTimeField(verbose_name='거래 시간'),
                ),
                (
                    'created_at',
                    models.DateTimeField(auto_now_add=True, verbose_name='기록 생성일'),
                ),
                (
                    'updated_at',
                    models.DateTimeField(auto_now=True, verbose_name='수정일'),
